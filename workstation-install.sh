...
confirm_question "Deseja instalar o VsCode" "install_vscode" "break_line"
...
confirm_question "Deseja instalar a font JetBrainsMono" "install_jet_brains_mono" "break_line"

install_git() {
  title "Install Git"
  source sources/install-git.sh
}
confirm_question "Deseja instalar o Git" "install_git" "break_line"

install_docker() {
  title "Install Docker"
  source sources/install-docker.sh
}
confirm_question "Deseja instalar o Docker" "install_docker" "break_line"

install_zsh() {
  title "Install Zsh"
  source sources/install-zsh.sh
}
confirm_question "Deseja instalar o zsh" "install_zsh" "break_line"
